...
$(function(){
	$("#sModifyBtn").click(function(){		
		...
		if(document.getElementById("simg0").checked != true && document.getElementById("simg1").checked != true && document.getElementById("simg2").checked != true 
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="row">
						<div class="col-md-12">
						 <span>
							<form id="smodifyfrm" action="../sBoard/sModifyProc.do"
				      encType="multipart/form-data"method="POST" >							   
				   		 	<input type="hidden" name="nowPage" value="${nowPage}" />
				   			<input type="hidden" name="sForiNo" value="${SBOARD.sno}" />
					  		<table align="center" width="800">
									<tbody>
										...
										<tr>
											<th>모임 제목</th>
											<td>
												<input type="text" name="stitle" id="stitle" value="${SBOARD.stitle}" />
											</td>											
										</tr>
										<tr>
											<th width="150">작성자</th>
										...
										<tr>
											<th>모임 내용</th>
											<td>
												<textarea cols="80" rows="5" name="scontent" id="scontent"  >${SBOARD.scontent}</textarea>
											</td>
										</tr>
										<tr>
											<th>모임 비용</th>
										...
										<tr>
											<th>모임 지역</th>
											<td>
												<input type="text" name="splace" id="splace" value="${SBOARD.splace}" />
											</td>
										</tr>
										<tr>
											<th>모임 장소</th>
											<td>
												<input type="text" name="sdplace" id="sdplace" value="${SBOARD.sdplace}"/>
											</td>
										</tr>
										<tr>
											<th>비밀번호</th>
										...
										<tr>
											<th>모임 날짜</th>
											<td>
												<input type="date" name="sday" id="sday" value="${SBOARD.sday}"/>
											</td>
										</tr>
										<tr>
											<th>모임 시간</th>
											<td>
												<input type="time" name="sdday" id="sdday" value="${SBOARD.sdday}"/>
											</td>
										</tr>
										<tr>
											<th>썸네일 이미지</th>
											<td>
							  				<input type="radio" name="simglink" id="simg0" value="${SBOARD.simglink}" />기존
										...
										<tr>
											<td align="center" colspan="2">
												<input type="button" class="btn btn-primary" value="수정완료" id="sModifyBtn" />
											</td>
										</tr>
									</tbody>
								</table>
...
<table align="center" width="500">
	<tr>
		<th align="center" colspan="2" height="17">			
		</th>
	</tr>
	<tr align="center"`>
		<td>
